                ...
                <div className="block">
                    ...
                    <div className="block">
                        <div className="mb-8">
                            ...
                            <p className="text-[#c8c8c8fc] uppercase tracking-widest font-bebas xs:text-sm sm:text-base md:text-lg 2xl:text-2xl">{data.aboutDescription}</p>
                        </div>
                        <div className="block mt-10">
                            <h4 className="uppercase font-extrabold text-white py-3 tracking-widest w-72 md:w-80 text-base md:text-lg">Get In Touch</h4>
                            <div className="flex flex-wrap gap-3 md:gap-5">
                                ...
                                <Link href={'https://www.linkedin.com/in/ahsan-azizan-33908b250/'} className="text-base sm:text-lg 2xl:text-2xl transition duration-300 font-extrabold uppercase text-gray-300  hover:text-blue-500 tracking-tighter">
