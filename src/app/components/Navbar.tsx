    ...
    <>
      <nav className="fixed left-1/2 z-[998] flex w-full max-w-[1440px] -translate-x-1/2 items-center justify-between bg-black px-10 py-4">
        <Link href={"/"}>
          <Image
            ...
            height={64}
            alt="Logo"
            className="rounded-full hover:drop-shadow-glow"
          />
        </Link>
        <div className="flex items-center gap-[18px]">
          <a
            href="mailto:ahsanaz461@gmail.com"
            className="group flex items-center gap-2 rounded-full border border-white px-[22px] py-[10px] text-lg transition-all duration-500 hover:bg-white hover:text-black hover:drop-shadow-glow"
          >
            {"Let's Talk"}
            <svg
              width="16"
          ...
          <button
            ...
            className="rounded-full border border-white px-[22px] py-4 transition-all duration-500 hover:bg-white hover:text-black hover:drop-shadow-glow"
          >
            <svg
              width="20"
              height="12"
      ...
      >
        <div className="mx-auto w-full max-w-[1440px] px-10">
          <div className="mb-16 flex w-full items-center justify-between py-4">
            <Link href={"/"}>
              <Image
                src={"/logo.png"}
                width={64}
          ...
          <div className="inline-flex flex-col gap-16">
            {links.map((link, i) => (
              <Link
                key={i}
                href={link.href}
                className={`text-7xl transition-all duration-500 after:h-[2px] hover:drop-shadow-glow`}
                style={{
                  color: `${
                    activeLinkIdx !== null
                      ? activeLinkIdx == i
