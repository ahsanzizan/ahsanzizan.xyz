...
export default async function Home() {
  ...
  return (
    <>
      <nav className="fixed left-1/2 flex w-full max-w-[1440px] -translate-x-1/2 items-center justify-between px-10 py-4">
        <Link href={"/"} className="text-lg transition-all duration-500">
          ahsanzizan
        </Link>
        <div className="flex items-center gap-[18px]">
          <a
            href="mailto:ahsanaz461@gmail.com"
            className="hover:drop-shadow-glow group flex items-center gap-2 rounded-full border border-white px-[22px] py-[10px] text-lg transition-all duration-500 hover:bg-white hover:text-black"
          >
            {"Let's Talk"}
            <svg
              width="16"
          ...
          <button className="hover:drop-shadow-glow rounded-full border border-white px-[22px] py-4 transition-all duration-500 hover:bg-white hover:text-black">
            <svg
              width="20"
              height="12"
              viewBox="0 0 20 12"
