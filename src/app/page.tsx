      ...
      <nav className="fixed left-1/2 flex w-full max-w-[1440px] -translate-x-1/2 items-center justify-between px-10 py-4">
        ...
        <div className="flex items-center gap-[18px]">
          <a
            ...
            className="hover:drop-shadow-glow group flex items-center gap-2 rounded-full border border-white px-[22px] py-[10px] transition-all duration-500 hover:bg-white hover:text-black"
          >
            {"Let's Talk"}
            <svg
              width="16"
