  ...
  return (
    <>
      ...
      <div className="px-5 lg:px-32 pt-12" id="main__section">
        ...
        <p className="text-base md:text-lg text-secondary"><a className="text-main hover:underline font-semibold" href="https://instagram.com/ahsanzizan">@ahsanzizan</a> made this website because he wanted to share his thought on things to other people, and he thought a blog would fit perfectly.</p>
      </div>
