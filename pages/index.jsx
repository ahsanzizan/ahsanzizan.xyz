  ...
  return (
    <>
      ...
      <div className="text-secondary px-5 lg:px-48 pt-12">
        ...
        <p className="text-base md:text-lg"><a className="text-main hover:underline font-semibold">@ahsan</a> made this website because he wanted to share his thought on things to other people, and he thought a blog would fit perfectly.</p>
      </div>
